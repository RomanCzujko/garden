...
(function(){var l;l="ontouchstart"in window;(function(d,n,g){var m;m=function(){function c(a,b){this.options=d.extend(!1,{},this.Defaults,b);this.$element=d(a);this.$clone=null;this.$win=d(g);this.$doc=d(n);this.currentLayout=this.options.layout;this.loaded=!1;this.focusOnHover=this.options.focusOnHover;this.isStuck=this.cloneTimer=this.focusTimer=!1;this.initialize()}c.prototype.Defaults={layout:"rd-navbar-static",deviceLayout:"rd-navbar-fixed",focusOnHover:!0,focusOnHoverTimeout:800,linkedElements:["html"],
  ...
  c.prototype.initialize=function(){this.$element.addClass("rd-navbar").addClass(this.options.layout);l&&this.$element.addClass("rd-navbar--is-touch");this.setDataAPI(this);this.options.domAppend&&this.createNav(this);this.options.stickUpClone&&this.createClone(this);this.$element.addClass("rd-navbar-original");this.addAdditionalClassToToggles(".rd-navbar-original","toggle-original","toggle-original-elements");this.applyHandlers(this);this.offset=this.$element.offset().top;this.height=this.$element.outerHeight();
    this.loaded=!0;return this};c.prototype.resize=function(a,b){var e,h;h=l?a.getOption("deviceLayout"):a.getOption("layout");e=a.$element.add(a.$clone);h===a.currentLayout&&a.loaded||(a.switchClass(e,a.currentLayout,h),null!=a.options.linkedElements&&d.grep(a.options.linkedElements,function(b,e){return a.switchClass(b,a.currentLayout+"-linked",h+"-linked")}),a.currentLayout=h);a.focusOnHover=a.getOption("focusOnHover");return a};c.prototype.stickUp=function(a,b){var e,h,f,c;h=a.getOption("stickUp");
    if(d("html").hasClass("ios")||a.$element.hasClass("rd-navbar-fixed"))h=!1;e=a.$doc.scrollTop();c=null!=a.$clone?a.$clone:a.$element;f=a.getOption("stickUpOffset");f="string"===typeof f?0<f.indexOf("%")?parseFloat(f)*a.height/100:parseFloat(f):f;if(h){if(e>=f&&!a.isStuck||e<f&&a.isStuck)if(a.$element.add(a.$clone).find("[data-rd-navbar-toggle]").each(function(){d.proxy(a.closeToggle,this)(a,!1)}).end().find(".rd-navbar-submenu").removeClass("opened").removeClass("focus"),e>=f&&!a.isStuck&&!a.$element.hasClass("rd-navbar-fixed"))"resize"===
    b.type?a.switchClass(c,"","rd-navbar--is-stuck"):c.addClass("rd-navbar--is-stuck"),a.isStuck=!0,a.options.callbacks.onStuck&&a.options.callbacks.onStuck.call(a);else{if("resize"===b.type)a.switchClass(c,"rd-navbar--is-stuck","");else c.removeClass("rd-navbar--is-stuck").one("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd",d.proxy(a.resizeWrap,a,b));a.isStuck=!1;a.options.callbacks.onUnstuck&&a.options.callbacks.onUnstuck.call(a)}}else a.$element.find(".rd-navbar-submenu").removeClass("opened").removeClass("focus"),
    a.isStuck&&(a.switchClass(c,"rd-navbar--is-stuck",""),a.isStuck=!1,a.resizeWrap(b));return a};c.prototype.resizeWrap=function(a){var b;if(null==this.$clone&&!this.isStuck){b=this.$element.parent();if(this.getOption("autoHeight"))return this.height=this.$element.outerHeight(),"resize"===a.type?(b.addClass("rd-navbar--no-transition").css("height",this.height),b[0].offsetHeight,b.removeClass("rd-navbar--no-transition")):b.css("height",this.height);b.css("height","auto")}};c.prototype.createNav=function(a){a.$element.find(".rd-navbar-dropdown, .rd-navbar-megamenu").each(function(){var a,
    e;a=d(this);e=this.getBoundingClientRect();e.left+a.outerWidth()>=g.innerWidth-10?this.className+=" rd-navbar-open-left":10>=e.left-a.outerWidth()&&(this.className+=" rd-navbar-open-right");return a.hasClass("rd-navbar-megamenu")?a.parent().addClass("rd-navbar--has-megamenu"):a.parent().addClass("rd-navbar--has-dropdown")}).parents("li").addClass("rd-navbar-submenu");d('<span class="rd-navbar-submenu-toggle"></span>').insertAfter(".rd-navbar-nav li.rd-navbar-submenu > a");a.options.callbacks.onDomAppend&&
  a.options.callbacks.onDomAppend.call(this);return a};c.prototype.createClone=function(a){a.$clone=a.$element.clone().insertAfter(a.$element).addClass("rd-navbar--is-clone");a.addAdditionalClassToToggles(".rd-navbar--is-clone","toggle-cloned","toggle-cloned-elements");return a};c.prototype.closeToggle=function(a,b){var e,h,f,c,k,g;e=d(b.target);c=!1;k=this.getAttribute("data-rd-navbar-toggle");a.options.stickUpClone&&a.isStuck?(f=".toggle-cloned",h=".toggle-cloned-elements",g=!e.hasClass("toggle-cloned")):
    (f=".toggle-original",h=".toggle-original-elements",g=!e.hasClass("toggle-original"));b.target!==this&&!e.parents(f+"[data-rd-navbar-toggle]").length&&!e.parents(h).length&&k&&g&&(e=d(this).parents("body").find(k).add(d(this).parents(".rd-navbar")[0]),e.each(function(){if(!c)return c=!0===(b.target===this||d.contains(this,b.target))}),c||(e.add(this).removeClass("active"),a.options.callbacks.onToggleClose&&a.options.callbacks.onToggleClose.call(this,a)));return this};c.prototype.switchToggle=function(a,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              b){var e,c,f;b.preventDefault();d(this).hasClass("toggle-cloned")?(f=".rd-navbar--is-clone",e=".toggle-cloned-elements"):(f=".rd-navbar-original",e=".toggle-original-elements");if(c=this.getAttribute("data-rd-navbar-toggle"))d(f+" [data-rd-navbar-toggle]").not(this).each(function(){var a;if(a=this.getAttribute("data-rd-navbar-toggle"))return d(this).parents("body").find(f+" "+a+e).add(this).add(-1<d.inArray(".rd-navbar",a.split(/\s*,\s*/i))?d(this).parents("body")[0]:!1).removeClass("active")}),d(this).parents("body").find(f+
    " "+c+e).add(this).add(-1<d.inArray(".rd-navbar",c.split(/\s*,\s*/i))?d(this).parents(".rd-navbar")[0]:!1).toggleClass("active");a.options.callbacks.onToggleSwitch&&a.options.callbacks.onToggleSwitch.call(this,a);return this};c.prototype.dropdownOver=function(a,b){var e;if(a.focusOnHover){e=d(this);clearTimeout(b);if(a.options.callbacks.onDropdownOver&&!a.options.callbacks.onDropdownOver.call(this,a))return this;e.addClass("focus").siblings().removeClass("opened").each(a.dropdownUnfocus)}return this};
  c.prototype.dropdownTouch=function(a,b){var e,c;e=d(this);clearTimeout(b);if(a.focusOnHover){c=!1;e.hasClass("focus")&&(c=!0);if(!c)return e.addClass("focus").siblings().removeClass("opened").each(a.dropdownUnfocus),!1;a.options.callbacks.onDropdownOver&&a.options.callbacks.onDropdownOver.call(this,a)}return this};c.prototype.dropdownOut=function(a,b){var e;a.focusOnHover&&(e=d(this),e.one("mouseenter.navbar",function(){return clearTimeout(b)}),a.options.callbacks.onDropdownOut&&a.options.callbacks.onDropdownOut.call(this,
    a),clearTimeout(b),b=setTimeout(d.proxy(a.dropdownUnfocus,this,a),a.options.focusOnHoverTimeout));return this};c.prototype.dropdownUnfocus=function(a){d(this).find("li.focus").add(this).removeClass("focus");return this};c.prototype.dropdownClose=function(a,b){var e;b.target===this||d(b.target).parents(".rd-navbar-submenu").length||(e=d(this),e.find("li.focus").add(this).removeClass("focus").removeClass("opened"),a.options.callbacks.onDropdownClose&&a.options.callbacks.onDropdownClose.call(this,a));
  ...
  c.prototype.setDataAPI=function(a){var b,e,d,c;a="- -xs- -sm- -md- -lg- -xl-".split(" ");c=[0,480,768,992,1200,1800];b=e=0;for(d=c.length;e<d;b=++e)this.$element.attr("data"+a[b]+"layout")&&(this.options.responsive[c[b]]||(this.options.responsive[c[b]]={}),this.options.responsive[c[b]].layout=this.$element.attr("data"+a[b]+"layout")),this.$element.attr("data"+a[b]+"device-layout")&&(this.options.responsive[c[b]]||(this.options.responsive[c[b]]={}),this.options.responsive[c[b]].deviceLayout=this.$element.attr("data"+
    a[b]+"device-layout")),this.$element.attr("data"+a[b]+"hover-on")&&(this.options.responsive[c[b]]||(this.options.responsive[c[b]]={}),this.options.responsive[c[b]].focusOnHover="true"===this.$element.attr("data"+a[b]+"hover-on")),this.$element.attr("data"+a[b]+"auto-height")&&(this.options.responsive[c[b]]||(this.options.responsive[c[b]]={}),this.options.responsive[c[b]].autoHeight="true"===this.$element.attr("data"+a[b]+"auto-height")),this.$element.attr("data"+a[b]+"stick-up-offset")&&(this.options.responsive[c[b]]||
  (this.options.responsive[c[b]]={}),this.options.responsive[c[b]].stickUpOffset=this.$element.attr("data"+a[b]+"stick-up-offset"))};c.prototype.getOption=function(a){var b,c;for(b in this.options.responsive)b<=g.innerWidth&&(c=b);return null!=this.options.responsive&&null!=this.options.responsive[c][a]?this.options.responsive[c][a]:this.options[a]};c.prototype.addAdditionalClassToToggles=function(a,b,c){return d(a).find("[data-rd-navbar-toggle]").each(function(){var e;d(this).addClass(b);e=this.getAttribute("data-rd-navbar-toggle");
    return d(this).parents("body").find(a).find(e).addClass(c)})};return c}();d.fn.extend({RDNavbar:function(c){var a;a=d(this);if(!a.data("RDNavbar"))return a.data("RDNavbar",new m(this,c))}});return g.RDNavbar=m})(window.jQuery,document,window);"undefined"!==typeof module&&null!==module?module.exports=window.RDNavbar:"function"===typeof define&&define.amd&&define(["jquery"],function(){return window.RDNavbar})}).call(this);
